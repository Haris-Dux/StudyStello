          ...
          <div className="mt-12 [column-fill:_balance] sm:columns-2 sm:gap-6 lg:columns-3 lg:gap-8">
            <div className="mb-8 sm:break-inside-avoid" data-aos="fade-up">
              <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                ...
                <p className="mt-4">
                  ...
                  StudyStello's tutors were a lifesaver. They helped me
            ...
            <div className="mb-8 sm:break-inside-avoid" data-aos="fade-up">
              <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                ...
                <p className="mt-4 text-gray-700">
                  "I was so nervous about my upcoming exam, but StudyStello's
            ...
            <div className="mb-8 sm:break-inside-avoid" data-aos="fade-up">
              <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                ...
                <p className="mt-4 text-gray-700">
                  ...
                  me, but StudyStello's assignment aid service has made it so
                  much easier. Their tutors provide clear and concise
                  explanations, and they always meet my deadlines. I'm so glad I
                  found StudyStello, and I highly recommend their services to
            ...
            <div className="mb-8 sm:break-inside-avoid" data-aos="fade-up">
              <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                ...
                <p className="mt-4 text-gray-700">
                  ...
                  compare to StudyStello. I'm so impressed with their services,
            ...
            <div className="mb-8 sm:break-inside-avoid" data-aos="fade-up">
              <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                ...
                <p className="mt-4 text-gray-700">
                  ...
                  assignments on my own. StudyStello's services have been a
            ...
            <div className="mb-8 sm:break-inside-avoid" data-aos="fade-up">
              <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                ...
                <p className="mt-4 text-gray-700">
                  "I've had to reach out to StudyStello's tutors at all hours of
            ...
            <div className="mb-8 sm:break-inside-avoid" data-aos="fade-up">
              <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                ...
                <p className="mt-4 text-gray-700">
                  ...
                  StudyStello's money-back guarantee gave me peace of mind. I'm
            ...
            <div className="mb-8 sm:break-inside-avoid" data-aos="fade-up">
              <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                ...
                <p className="mt-4 text-gray-700">
                  ...
                  assignments. StudyStello's assignment help service has been a
